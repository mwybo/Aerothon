...
#==============================================================================
        def Refresh(self):
            # changes made by shiggins 12/10/2015...needed to place payload bay
            #  how I told aerothon...not how aerothon decided to place it, so I
            #  am now using common sense...
            """
            ...
            #self.Position = (self.XcgSecFrac,0.5,0) #shiggins 12/10/2015
            ...
            #Length = self.length #shiggins 12/10/2015 hack for now
            #Width = self.width #shiggins 12/10/2015 hack for now

            Volume = Weight / self.Material.ForceDensity
            
            #self.LWH = [Volume / (Width*Length), Width, Length ]
            self.LWH = [Volume/(Width*Length), Width, Length] #shiggins 12/10/2015
